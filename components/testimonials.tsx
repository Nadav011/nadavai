...
const testimonials = [
  {
    name: "דניאל כהן",
    role: "CEO, TechFlow",
    text: "נדב בנה לנו את כל הפלטפורמה בשבועיים. מה שצוות של 5 אנשים היה עושה בחודשים. תוצאה מדהימה.",
    rating: 5,
  },
  {
    name: "מיכל לוי",
    role: "Product Manager",
    text: "הדשבורד שנדב בנה לנו שינה את כל הדרך שאנחנו עובדים. אוטומציות ש-AI מנהל - חוסכות לנו שעות כל יום.",
    rating: 5,
  },
  {
    name: "אורי שמש",
    role: "Startup Founder",
    text: "מ-MVP לגרסה 1.0 בזמן שיא. נדב לא רק מפתח - הוא מבין מוצר, UX, ואיך AI יכול לשדרג הכל.",
    rating: 5,
  },
]
