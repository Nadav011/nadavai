...
const projects = [
  {
    title: "Mexicani",
    description: "מערכת ניהול זכיינות ברמת Enterprise - 149 עמודים, 111 טבלאות, 38 Edge Functions. ניהול סניפים, הזמנות, מלאי, עובדים ודוחות מתקדמים.",
  ...
  {
    title: "Cash",
    description: "מערכת ניהול משלוחים PWA עם תמיכה אופליין מלאה. סנכרון חכם, IndexedDB, ותור פעולות לעבודה ללא חיבור.",
  ...
  {
    title: "Shifts",
    description: "מערכת ניהול משמרות עם Drag & Drop, התראות Push, ולוח זמנים אינטראקטיבי. 154 קומפוננטות, 25 hooks.",
  ...
  {
    title: "hatumdigital",
    description: "מערכת ניהול הזמנות עם אפליקציית iOS. Entity Factory pattern, Result<T,E> לטיפול בשגיאות, וולידציה עם Zod.",
    ...
    <section id="projects" aria-label="פרויקטים" className="relative py-24 md:py-32">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <SectionHeader
          ...
          title="מה"
          highlight="בניתי"
          description="כל פרויקט נבנה מאפס עם AI - אפליקציות production, מערכות enterprise, ואפליקציות מובייל. הנה ההוכחה."
        />
